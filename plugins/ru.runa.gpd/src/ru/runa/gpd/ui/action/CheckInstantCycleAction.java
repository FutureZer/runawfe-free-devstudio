...
import ru.runa.gpd.algorithms.cycles.CheckInstantCycleAlgorithm;
import ru.runa.gpd.algorithms.cycles.NodeClassification;
...
public class CheckInstantCycleAction extends BaseActionDelegate {
    @Override
    public void run(IAction action) {
        ...
        if (editorPart != null) {
            ...
            if (editorInput instanceof FileEditorInput) {
                ...
                CheckInstantCycleAlgorithm cycAlgo = new CheckInstantCycleAlgorithm(nodes, transitions);
                cycAlgo.start();
                if (cycAlgo.hasInstantCycle()) {
